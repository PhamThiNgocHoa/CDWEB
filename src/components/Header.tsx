...
function Header() {
    ...
    return (
        <header>
            ...
            <div className="w-full py-4 px-4 md:px-10 lg:px-20 xl:px-32 flex justify-between items-center">
                {/* Logo */}
                <div className="logo flex-shrink-0">
                    <img className="w-12 h-12 md:w-16 md:h-16 rounded-full" src="/logo.png" alt="Logo" />
                </div>

                <button className="text-red-500 text-2xl rounded-lg p-2 ml-6 flex-shrink-0">
                    <img className="w-12 h-8 md:w-12 md:h-8" src="/image/menu.png" alt="Logo" />
                </button>

                {/* Ô tìm kiếm */}
                <div className="flex items-center flex-grow mx-4 max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl border rounded-md h-12">
                    <input type="text" placeholder="Tìm kiếm..." className="w-full p-2 focus:outline-none text-sm sm:text-base" />
                ...
                <div className="nav flex text-xl text-gray-500 space-x-2 mr-20">
                    ...
                    {/* Tài khoản */}
                    <div className="relative flex flex-col items-center cursor-pointer hover:text-red-500 px-4" onClick={toggleMenu}>
                        <div className="flex flex-col items-center justify-center cursor-pointer px-2 group">
